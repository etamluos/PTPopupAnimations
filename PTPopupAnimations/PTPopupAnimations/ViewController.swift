...
//  PTPopupAnimations
//
//  Created by Phung Tung on 11/20/18.
//  Copyright © 2018 Phung Tung. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    private var popupOffset: CGFloat = 440
    ...
    private lazy var panRecognizer: PTPanGestureRecognizer = {
        let recognizer = PTPanGestureRecognizer()
        recognizer.addTarget(self, action: #selector(popupViewPaned(_:)))
        return recognizer
    }()
    ...
    @objc private func popupViewPaned(_ recognizer: UIPanGestureRecognizer) {
...
class PTPanGestureRecognizer: UIPanGestureRecognizer {
